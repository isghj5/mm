...
typedef void (*DmGmDialogueFunc)(struct DmGm*, PlayState*);


#define DMGM2_8000 0x8000

#define DMGM2_GET_PATH_INDEX(thisx) ((thisx)->params & 0xFF)
#define DMGM2_GET_8000(thisx) ((thisx)->params & DMGM2_8000)

#define DMGM2_STATE_8                (1 << 3) // path related
#define DMGM2_STATE_REACHED_PATH_END (1 << 4)
#define DMGM2_STATE_ENGAGED          (1 << 5)
#define DMGM2_STATE_IGNORE_GRAVITY   (1 << 6)
#define DMGM2_STATE_FACE_TARGET      (1 << 7)
#define DMGM2_STATE_UPDATE_EYES      (1 << 8)
#define DMGM2_STATE_LOST_ATTENTION   (1 << 9)
#define DMGM2_STATE_TALKING          (1 << 10)
#define DMGM2_STATE_DRAW_TRAY        (1 << 11)
#define DMGM2_STATE_DRAW_UMBRELLA    (1 << 12)
#define DMGM2_STATE_DRAW_BROOM       (1 << 13)
#define DMGM2_STATE_DRAW_KAFEIS_MASK (1 << 14)
#define DMGM2_STATE_DRAW_CHOPSTICKS  (1 << 15)
...
typedef struct DmGm {
    ...
    /* 0x18C */ DmGmDialogueFunc dialogueFunc;
    ...
    /* 0x38A */ s16 savedFaceIndex; // DmGmFace enum
    /* 0x38C */ s16 faceIndex; // DmGmFace enum
    /* 0x38E */ s16 eyeTimer;
