...
void BgF40Swlift_Init(Actor* thisx, PlayState* play) {
    ...
    // my guess is they wanted to use a switch flag to move the platform to change dungeon layout
    //if (index != 0) {
        //Actor_Kill(&this->dyna.actor);
        //return;
    //}
    ...
    //this->dyna.actor.params = 0; // resetting??
}
...
void BgF40Swlift_Update(Actor* thisx, PlayState* play2) {
    ...
    //} else {
        ...
        this->dyna.actor.world.pos.y = this->dyna.actor.home.pos.y + (Math_SinF(this->timer * (M_PI / 24.0f)) * 5.0f);
    //}
}
